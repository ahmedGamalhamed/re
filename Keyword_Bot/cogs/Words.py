...
class Words(commands.Cog):
    ...
    async def add(self, ctx, word, channel: discord.TextChannel, people: commands.Greedy[discord.Member], roles: commands.Greedy[discord.Role], *, text_to_send=None):
        ...
        async with aiosqlite.connect("DATA/bot.db") as db:
            c = await db.execute(
                ...
                """, {'g_id': ctx.guild.id, 'word': word.lower(), 'chn_id': channel.id, 't_t_s': text_to_send}
            )
